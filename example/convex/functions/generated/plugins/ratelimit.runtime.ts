...
const procedureRegistry = {
  "cleanup": ["mutation", typedProcedureResolver(createGeneratedFunctionReference<"mutation", "internal", typeof import("../../plugins/ratelimit").cleanup>("plugins/ratelimit:cleanup"), () => (require("../../plugins/ratelimit") as Record<string, unknown>)["cleanup"])],
} as const;
...
export function createRatelimitCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createRatelimitHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
