...
| Field | Type | Description |
| --- | --- | --- |
| `value` | `number` | Tokens left at read time across the stored capacity. Sampled shards are summed, then scaled up by the capacity share they cover |
